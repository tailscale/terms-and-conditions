...
Configuration information (including access control list information, webhooks, SCIM information)</li><li>
Personal Data resulting from your use of an Integration or other Third Party Service (as applicable)</li></ul> |
